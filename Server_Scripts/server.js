...
const {getDBsZip} = require("./Debugging_Scripts/getZipDBs.js")
...
app.get("/getDBZip",(req,res) => { //get request that returns Databases as a zip
    getDBsZip(req,res);
})
...
app.get("/get_Media_DBs",(req,res) => { //for debugging [returns confession got and confession sent DB of all users]
