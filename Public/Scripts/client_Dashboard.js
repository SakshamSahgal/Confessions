                                        ...
                                        <div class="card" style="max-width: 80vw; border:5px solid black">
                                            ...
                                            <div class="card-footer">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="row">
                                                        <div class="col">
                                                            <button class="btn btn-sm btn-secondary" onclick=viewComments('${JSON.stringify(thisPost.Comments)}')  ${(thisPost.Visibility == "Anonymous") ? "disabled" : ""} ><i class="bi bi-chat" style="font-size: 12px;">Comment</i></button>
                                                        </div>
                                                        <div class="col" >
                                                            <div class="dropdown">
